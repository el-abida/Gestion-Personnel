...
private fun PersonnelDto.toDomain() = Personnel(
    id = this.id ?: 0L,
    ppr = this.ppr,
    cin = this.citoyen.cin ?: "",
    nomFr = this.citoyen.nomFr ?: "",
    nomAr = this.citoyen.nomAr ?: "",
    prenomFr = this.citoyen.prenomFr ?: "",
    prenomAr = this.citoyen.prenomAr ?: "",
    email = this.citoyen.email ?: "",
    telephone = this.citoyen.telephone ?: "",
    dateNaissance = this.citoyen.dateNaissance ?: "",
    lieuNaissance = this.citoyen.lieuNaissance ?: "",
    sexe = this.citoyen.sexe ?: "",
    adresse = this.citoyen.adresse ?: "",
    photoUrl = this.citoyen.photoUrl,
