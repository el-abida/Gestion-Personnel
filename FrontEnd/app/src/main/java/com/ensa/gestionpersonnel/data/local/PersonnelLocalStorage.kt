...
object PersonnelLocalStorage {
    ...
    fun createPersonnel(dto: PersonnelDto): Personnel {
        val personnel = Personnel(
            id = nextId++,
            ppr = dto.ppr,
            cin = dto.citoyen.cin ?: "", // Handle nullable
            nomFr = dto.citoyen.nomFr ?: "",
            nomAr = dto.citoyen.nomAr ?: "",
            prenomFr = dto.citoyen.prenomFr ?: "",
            prenomAr = dto.citoyen.prenomAr ?: "",
            email = dto.citoyen.email ?: "",
            telephone = dto.citoyen.telephone ?: "",
            dateNaissance = dto.citoyen.dateNaissance ?: "",
            lieuNaissance = dto.citoyen.lieuNaissance ?: "",
            sexe = dto.citoyen.sexe ?: "",
            adresse = dto.citoyen.adresse ?: "",
            photoUrl = dto.citoyen.photoUrl,
